...
public class GeneradorTiquetes
{
    ...
    //Constructor
    public GeneradorTiquetes(Set<String> codigosSet) {
    	codigos = codigosSet;
    }
    /**
    ...
    {
        codigos.add(Integer.valueOf(unTiquete.getCodigo()).toString());
    }
    ...
    {
        // TODO implementar
    	if (codigoTiquete != null) return codigos.contains(codigoTiquete);
        return false;
    }
}
